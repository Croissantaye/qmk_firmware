...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ergodox(
        ...
        KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                                    
                        KC_HOME, KC_END, KC_ENT,KC_SPC , RAISE ,    
                                                KC_LGUI, KC_LALT,       
                         ...
                         KC_BSPC,             KC_LBRC,KC_RBRC,
        KC_RALT, TG(RAISE), KC_DEL
    ),
    ...
    [_RAISE] = LAYOUT_ergodox(
        ...
        _______ , _______ ,KC_VOLD,KC_VOLU,KC_MUTE, KC_SLEP ,
        _______, KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT, _______  ,
        _______, _______ , KC_MNXT,KC_MPLY,KC_MPRV, _______  ,
                        KC_PGUP, KC_PGDN,
